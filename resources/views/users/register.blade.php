            ...
            <div class="col-lg-12 d-flex justify-content-center" id="tabClr">
              <div class="login-secton">
                <div class="row d-flex justify-content-center">
                    <!-- Login Form -->
                    <div id="login-form">
                    <h5 class="mb-3 text-center login-hed">Register New Account</h5>
                     <form method="POST" action="{{ route('userRegister') }}">
                        @csrf
                        <div class="mb-3 form-div11">
                            <label class="form-label form-div12">Full Name</label>
                            <input type="text" class="form-control form-div13" name="name" placeholder="Enter your full name" required>
                            @if($errors->has('name'))
                        ...
                        <div class="mb-3">
                            <label class="form-label form-div12">Password</label>
                            <input type="password" class="form-control form-div13" name="password" placeholder="Create a password" required>
                            @if($errors->has('password'))
                                <span class="text-danger">{{ $errors->first('password') }}</span>
                            @endif
                        </div>
                        <div class="mb-3">
                            <label class="form-label form-div12">Confirm Password</label>
                            <input type="password" class="form-control form-div13" name="password_confirmation" placeholder="Confirm password" required>
