...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('users-css/form.css') }}" rel="stylesheet">
    <link href="{{ asset('users-css/dasboard.css') }}" rel="stylesheet">
  ...
  <body>
    ...
    <script>
        $(document).ready(function() {
            ...
            var userId = $('#generate-button').data('id');
            // alert(userId);
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
            ...
            $.ajax({
                ...
                success: function(data) {
                    $(".myAvailableCoins").load(location.href + " .myAvailableCoins");
                    $(".reloadDivBtn").load(location.href + " .reloadDivBtn");
                },
                error: function(error) {
                    console.log(error.responseText);
                }
