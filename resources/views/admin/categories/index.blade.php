        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="category-top">
                    <a href="{{ route('categories.create') }}" class="btn btn-primary Add-Category">{{ trans('translation.add_category') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="table-scroll">
                    <h1 class="Category_List">{{ trans('translation.category_list') }}</h1>
                    <div class="card-body">
            ...
            columns: [
                ...
                { data: "title" },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        actions += ' <a class="btn btn-xs btn-info" href="/admin/categories/' + row.id + '/edit">{{ trans('translation.edit') }}</a>';
                        actions += ' <form action="/admin/categories/' + row.id + '" method="POST" ' +
