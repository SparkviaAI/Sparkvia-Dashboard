...
Route::get('/n-h', function () {
    return redirect()->away('https://auth.sparkvia.ai/');
})->name('newHomePage');
// Route::get('/', [LandingPageController::class, 'getHomePage'])->name('getHomePage');
Route::get('/old-landing-page', [LandingPageController::class, 'getHomePage'])->name('getHomePage');
Route::get('/', function () {
...
//////////////////////////////////////// ADMIN ROUTES START ///////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
Route::domain('auth.sparkvia.ai')->group(function () {
...
Route::domain('app.sparkvia.ai')->group(function () {
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::group(['middleware' => 'auth'], function () {
            ...
            Route::put('settings/xrp-conversion-token', [SettingsController::class, 'xrpConversionToken'])->name('settings.xrp-conversion-token');
            ////////////////// SETTING ROUTES ENDS ///////////////////
